...
- Discussions en français **ou en anglais** ; code, commentaires, commits et
  Javadoc en anglais (commits au format conventional, sans trailer).
- Travail technique (feature, refactor, bugfix) : branche → push →
  **Pull Request** vers `main` → merge après relecture, branche supprimée.
  Petites retouches (doc, typo, fix mineur) : commit direct sur `main`.
